...
int tuix_create_object_ex(char* builder_name, char* scene_name, float width_mod, float height_mod, float margin_top_mod, float margin_left_mod, int set_focus) {
...
int tuix_create_object(char* builder_name, char* scene_name, float width_mod, float height_mod, float margin_top_mod, float margin_left_mod) {
    return tuix_create_object_ex(builder_name, scene_name, width_mod, height_mod, margin_top_mod, margin_left_mod, 1);
}
